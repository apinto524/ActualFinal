...
class alphaHelixScene: SCNScene{
    ...
    func createScene(){
        ...
        var connectionGeom = SCNBox(width: 70, height: 500, length: 70, chamferRadius: 27)
        ...
        while count < 20 {
            ...
            //midpoint
            var midPointx = Float(xPosition + pointToNTerm.x) / 2.0
            var midPointy = Float(yPosition + pointToNTerm.y) / 2.0
            var midPointz = Float(zPosition + pointToNTerm.z) / 2.0
